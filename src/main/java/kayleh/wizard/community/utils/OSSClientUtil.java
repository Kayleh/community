//package kayleh.wizard.community.utils;
//
///**
// * @Author: Wizard
...
//            throw new RuntimeException("上传图片大小不能超过 1M!");
////            throw new ImgException("上传图片大小不能超过 1M!");
//        }
...
//        Date expiration = new Date(new Date().getTime() + 1000 * 24 * 365 * 10);
//        // 生成 URL
